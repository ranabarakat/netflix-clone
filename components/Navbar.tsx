    ...
    return (
        <nav className="w-full fixed z-40">
            <div className={`px-4 md:px-16 py-4 flex flex-row items-center transition duration-500 ${showBackground ? 'bg-zinc-900 bg-opacity-90' : ''}`}>
                <img className="h-4 lg:h-7" src="/images/logo2.png" alt="" />
                ...
                <div onClick={toggleMobileMenu} className="lg:hidden flex flex-row items-center ml-8 gap-2 cursor-pointer relative">
                    ...
                    <BsChevronDown className={`text-white transition  hover:text-gray-200 ${showMobileMenu ? 'rotate-180' : 'rotate-0'}`} />
                    <MobileMenu visible={showMobileMenu} />
                </div>
                <div className="flex flex-row ml-auto gap-7 items-center">
                    <div className="cursor-pointer text-gray-200 hover:text-gray-400 transition text-lg">
                        <BsSearch />
                    </div>
                    <div className="cursor-pointer text-gray-200 hover:text-gray-400 transition text-lg">
                        <BsBell />
